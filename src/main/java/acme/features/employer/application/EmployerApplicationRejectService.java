...
public class EmployerApplicationRejectService implements AbstractUpdateService<Employer, Application> {
	...
	public void validate(final Request<Application> request, final Application entity, final Errors errors) {
		...
		if (!errors.hasErrors("rejectJustification")) {
			...
			mandatoryJustification = request.getModel().getString("rejectJustification").equals("");
			errors.state(request, !mandatoryJustification, "rejectJustification", "employer.application.error.justification");
		}
	}
